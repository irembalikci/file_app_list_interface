                        ...
                        return Card(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              ...
                              height: 120,
                              cacheWidth:
                                  400, // Piksel bazında yeniden ölçekleme
                              cacheHeight: 240,
                            ),
                          ),
                        );
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: Icon(Icons.home, color: textColor1),
            label: 'Home',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.search, color: textColor1),
            label: 'Ürün Ara',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.shopping_basket_outlined, color: textColor1),
            label: 'Filem',
          ),
          BottomNavigationBarItem(
